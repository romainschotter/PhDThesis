%//------ Section 04 -------------------------------------------------------------------------------------------------
\chapter{Measurement of the correlated production of strange hadrons}
...
A way to shed more light on the situation is to perform more multi-differential studies, typically of the angular and rapidity correlations between different hadron species. These bring information on the quark production, and consequently on the hadronisation. Two hadrons produced out of the breaking of a colour string into a quark-antiquark pair, as modelled by \Pythia, should exhibit a strong local correlation. On the other hand, if the quarks are produced in the early stage of the collision -- the so-called \say{prehadrons} in the \Epos framework \cite{wernerCorecoronaProcedureMicrocanonical2023} -- and hadronise later, such correlation should vanish.
...
Beyond the track selections in common with the hyperons (\Sec\ref{subsec:TrackSelections}), only tracks of sufficiently good quality are selected by requiring a reduced $\chi^2$ up to 36 and 4, for the ITS- and TPC-standalone tracks respectively\footnote{The tighter selection on the goodness of the TPC-standalone track is related to the fact that the TPC is the main tracking device in ALICE and so, contributes the most to the track quality.}. The agreement between the TPC-standalone track, constrained to the preliminary primary\break vertex (\Sec\ref{subsec:EventReco}), and global track is quantified by the so-called \textit{golden} $\chi^{2}$; its value should be smaller than 36. Along the same line, each track must have passed the final refit in the ITS, and be associated with at least one hit in the innermost ITS layers, the most granular detector of the experiment. To ensure a good momentum resolution, the fraction of found crossed TPC readout rows over the number of findable clusters must reach at least 80\%.  
...
\begin{figure}[h]
	\begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_0.60\_1.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_1.00\_1.20.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_1.20\_1.40.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_1.40\_1.60.eps}
    \end{minipage}  \\
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_1.60\_1.80.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_1.80\_2.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_2.00\_2.20.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_2.20\_2.50.eps}
    \end{minipage}  \\
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_2.50\_2.90.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_2.90\_3.40.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_3.40\_4.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_4.00\_5.00.eps}
    \end{minipage}  \\
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_5.00\_6.50.eps}
    \end{minipage}
    \hfill
...
\begin{figure}[h]
	\begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_0.60\_1.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_1.00\_1.20.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_1.20\_1.40.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_1.40\_1.60.eps}
    \end{minipage}  \\
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_1.60\_1.80.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_1.80\_2.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_2.00\_2.20.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_2.20\_2.50.eps}
    \end{minipage}  \\
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_2.50\_2.90.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_2.90\_3.40.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_3.40\_4.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.25\textwidth}
		\hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_4.00\_5.00.eps}
    \end{minipage}  \\
    \begin{minipage}[t]{.25\textwidth}
        \hspace*{-2.5cm}
        \includegraphics[width=1.75\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_5.00\_6.50.eps}
    \end{minipage}
    \hfill
...
\begin{figure}[!p]
	\begin{minipage}[t]{.5\textwidth}
        \hspace*{-1.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_1.00\_1.60.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_1.60\_2.20.eps}
    \end{minipage}\\
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{-1.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_2.20\_2.60.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_2.60\_3.00.eps}
    \end{minipage}\\
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{-1.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_3.00\_3.80.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{0.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadeNeg\_Mult0.00\_50.00-dpT\_3.80\_6.50.eps}
    \end{minipage}
    \hfill
...
\begin{figure}[!p]
	\begin{minipage}[t]{.5\textwidth}
        \hspace*{-1.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_1.00\_1.60.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_1.60\_2.20.eps}
    \end{minipage}\\
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{-1.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_2.20\_2.60.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_2.60\_3.00.eps}
    \end{minipage}\\
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{-1.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_3.00\_3.80.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.5\textwidth}
        \hspace*{0.5cm}
        \includegraphics[width=1.25\textwidth, angle=0]{Figs/Chapter6/CascadePos\_Mult0.00\_50.00-dpT\_3.80\_6.50.eps}
    \end{minipage}
    \hfill
...
\begin{figure}[p]
	\begin{minipage}[t]{.3\textwidth}
        \hspace*{-2.cm}
        \includegraphics[width=1.85\textwidth, angle=0]{Figs/Chapter6/myCanvas0.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.3\textwidth}
		\hspace*{-3.cm}
        \includegraphics[width=1.85\textwidth, angle=0]{Figs/Chapter6/Resonance\_CascSignal\_Mult0.00\_50.00-dpT\_0.40_0.80-dy\_-1.00\_1.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.3\textwidth}
		\hspace*{-4.cm}
        \includegraphics[width=1.85\textwidth, angle=0]{Figs/Chapter6/Resonance\_CascSignal\_Mult0.00\_50.00-dpT\_0.80_1.20-dy\_-1.00\_1.00.eps}
    \end{minipage} \\
    \begin{minipage}[t]{.3\textwidth}
        \hspace*{-2.cm}
        \includegraphics[width=1.85\textwidth, angle=0]{Figs/Chapter6/Resonance\_CascSignal\_Mult0.00\_50.00-dpT\_1.20_1.80-dy\_-1.00\_1.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.3\textwidth}
		\hspace*{-3.cm}
        \includegraphics[width=1.85\textwidth, angle=0]{Figs/Chapter6/Resonance\_CascSignal\_Mult0.00\_50.00-dpT\_1.80_2.60-dy\_-1.00\_1.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.3\textwidth}
		\hspace*{-4.cm}
        \includegraphics[width=1.85\textwidth, angle=0]{Figs/Chapter6/Resonance\_CascSignal\_Mult0.00\_50.00-dpT\_2.60_3.40-dy\_-1.00\_1.00.eps}
    \end{minipage}  \\
    \begin{minipage}[t]{.3\textwidth}
        \hspace*{-2.cm}
        \includegraphics[width=1.85\textwidth, angle=0]{Figs/Chapter6/Resonance\_CascSignal\_Mult0.00\_50.00-dpT\_3.40_4.20-dy\_-1.00\_1.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.3\textwidth}
		\hspace*{-3.cm}
        \includegraphics[width=1.85\textwidth, angle=0]{Figs/Chapter6/Resonance\_CascSignal\_Mult0.00\_50.00-dpT\_4.20_5.00-dy\_-1.00\_1.00.eps}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{.3\textwidth}
		\hspace*{-4.cm}
        \includegraphics[width=1.85\textwidth, angle=0]{Figs/Chapter6/Resonance\_CascSignal\_Mult0.00\_50.00-dpT\_5.00_11.00-dy\_-1.00\_1.00.eps}
    \end{minipage}  
%\subfigure[]
%{
%	\includegraphics[width=0.45\textwidth, angle=0]{Figs/Chapter6/InvMassFit\_Resonance\_Pt04\_08\_WithBkg.eps}
%}
%\subfigure[]
%{
%	\includegraphics[width=0.45\textwidth, angle=0]{Figs/Chapter6/InvMassFit\_Resonance\_Pt04\_08\_WithBkg.eps}
...
The event mixing technique is taken as the default option, as it will later facilitate another part of the analysis \Sec\ref{subsec:EvtMixingCascPhi}. The rotating procedure is however used in the systematic study. 
...
To account for the uncorrelated pairs of particles, the correlation function has to be re-defined such that it is given by the ratio of the measured per-trigger yield to the one obtained in different events. In other words, this means that the final correlation function corresponds in fact to 
\begin{equation}
...
\subfigure[]
	{
	\includegraphics[width=0.8\textwidth, angle=0]{Figs/Chapter6/PerTriggerYield\_VsRap\_XiPhi\_Ratio\_MB\_SameAndMixEvent.eps}
	\label{fig:PerTriggerYieldXiRap}
	}
\centering
\subfigure[]
	{
	\includegraphics[width=0.8\textwidth, angle=0]{Figs/Chapter6/PerTriggerYield\_VsPhi\_XiPhi\_Ratio\_MB\_SameAndMixEvent.eps}
...
\subfigure[]
	{
	\includegraphics[width=0.8\textwidth, angle=0]{Figs/Chapter6/CorrelationXiVsDeltaY\_MBAndHM\_NoSyst.eps}
	\label{fig:PerTriggerYieldXiRapRatio}
	}
\centering
\subfigure[]
	{
	\includegraphics[width=0.8\textwidth, angle=0]{Figs/Chapter6/CorrelationXiVsDeltaPhi\_MBAndHM\_NoSyst.eps}
...
\subfigure[]
	{
	\includegraphics[width=0.8\textwidth, angle=0]{Figs/Chapter6/CorrelationOmegaVsDeltaY\_HM\_NoSyst.eps}
	\label{fig:PerTriggerYieldOmegaRapRatio}
	}
\centering
\subfigure[]
	{
	\includegraphics[width=0.8\textwidth, angle=0]{Figs/Chapter6/CorrelationOmegaVsDeltaPhi\_HM\_NoSyst.eps}
	\label{fig:PerTriggerYieldOmegaPhiRatio}
	}
...
%The initial goal being to correlate a \rmOmegaPM baryon to \rmPhiMes meson, an attempt has been made to obtain similar results but with \rmOmegaPM as trigger particle.
...
\subfigure[]
	{
	\includegraphics[width=1\textwidth, angle=0]{Figs/Chapter6/PerTriggerYield\_VsRap\_XiPhi\_SystCasc\_MB.eps}
	\label{fig:SystPerTriggerYieldXiRapRatioCascade}
	}
\centering
\subfigure[]
	{
	\includegraphics[width=1\textwidth, angle=0]{Figs/Chapter6/PerTriggerYield\_VsPhi\_XiPhi\_SystCasc\_MB.eps}
...
\subfigure[]
	{
	\includegraphics[width=1\textwidth, angle=0]{Figs/Chapter6/PerTriggerYield\_VsRap\_XiPhi\_Syst\_MB.eps}
	\label{fig:SystPerTriggerYieldXiRapRatio}
	}
\centering
\subfigure[]
	{
	\includegraphics[width=1\textwidth, angle=0]{Figs/Chapter6/PerTriggerYield\_VsPhi\_XiPhi\_Syst\_MB.eps}
...
All the tools are already implemented and the data available to perform the systematic study on the four first points. They have not been addressed yet, as explained above. 
...
\caption{Left panels: final measurements of the correlation between the \rmXiPM hyperons and \rmPhiMes resonances, at mid-rapidity ($\absrap < 0.5$), as a function of (a) their difference in rapidity, $\Delta y$, and (c) in azimuth, $\Delta \varphi$, in minimum-bias (full marker) and high-multiplicity (open marker) pp collisions at \sqrtS = 13 \tev. Right panels: comparison to different MC predictions (\Pythiaeight Monash 2013, \Pythiaeight including colour rope and colour reconnection mechanisms, \EposFour using a parametrised fluid expansion) for the correlation in (b) $\Delta y$ and (d) $\Delta \varphi$ in minimum-bias pp collisions at \sqrtS = 13 \tev. The error bars include the statistical and systematic uncertainties.}
...
%Furthermore, the analysis could be refined and improved, most notably for the \rmOmegaPM baryons. The available statistics being the constraining factor -- even in high-multiplicity pp collisions --, such extension can only be carried out using the LHC Run-3 data. As a comparison, over the course of 2022, three hundred times more data than in the LHC Run-2 have been recorded \cite{cern152ndLHCCMeeting2022}. Beside this enormous amount of statistics, ALICE is currently implementing a cascade trigger, designed typically for this kind of analysis. 
