\documentclass[ALICE,manyauthors]{cernphprep_ResumeInFrench}
%\documentclass[12pt,oneside,a4paper]{book} % This style for A4 format. 

\include{Preamble_ResumeInFrench}
\include{ScientificNotationCommands}
...
\include{AppendixExtendedAbstractFrench}
%\include{Introduction} % Introduction
%\include{StandardModel} % Data sets
%\include{ALICEExperiment} % The ALICE experiment
%\include{V0CascReconstruction} % V0 and cascade reconstruction
%\include{CPTAnalysis} % The CPT analysis
%\include{CorrelationAnalysis} % Correlation analysis
%\include{Discussion} % Discusssion
...
%\input{AppendixCPTAnalysis}
%\input{AppendixCorrelatedAnalysis}
