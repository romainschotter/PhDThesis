...
\end{center}
\caption{(a) screening effect of an electron in QED, induced the cloud of virtual \EplusEminus\ pairs surrounding the charged particle; (b) analogy with the screening effect in a dielectric material; (c) pictural representation of the colour spread of an initially red-coloured quark~\cite{deurQCDRunningCoupling2016}. }
...
%since the partons are deconfined and were thought to interact mildly -- similarly to plasmas --, this state of matter was called the \textit{quark-gluon plasma} (QGP)
