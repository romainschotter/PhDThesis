...
\newcommand{\ToDo}      {\textcolor{Gray}{\scriptsize \textsc{ToDo}}\xspace}
...
\newcommand{\piPlus}        {\mbox{$\mathrm {\pi^+}$}\xspace}
...
\newcommand{\rmKzero}    {\ensuremath{\mathrm {K^0}}\xspace}
\newcommand{\rmAKzero}   {\ensuremath{\mathrm {\overline{K^0}}}\xspace}
