...
\begin{table}[h]
    ...
    \noalign{\smallskip}\hline \noalign{\smallskip}
    \bf Particle & \multicolumn{2}{c|}{\bf Randomisation interval}  & \multicolumn{2}{c}{\bf Uncertainty on the measured...}  \\
